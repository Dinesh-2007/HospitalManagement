...
export default function DoctorConsultationPage() {
  ...
  return (
    <div className="h-full w-full grid grid-cols-1 gap-6 lg:grid-cols-12">
      ...
      {/* Right Panel */}
      <div className={`col-span-1 flex flex-col h-[calc(100vh-8rem)] rounded-2xl border border-gray-200 bg-white shadow-xs dark:border-gray-800 dark:bg-gray-900/50 overflow-hidden transition-all duration-300 ${leftPanelCollapsed ? "lg:col-span-11 xl:col-span-11" : "lg:col-span-9 xl:col-span-9"}`}>
