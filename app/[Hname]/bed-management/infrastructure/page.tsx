      ...
      <div className="space-y-6">
        ...
        {activeTab === "generator" && (
          <div className="space-y-6">
            ...
            {/* Step Navigation Buttons below the designer */}
            <div className="flex items-center justify-between bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 rounded-2xl p-4 shadow-sm">
              <button
                type="button"
                onClick={() => { setError(null); setCurrentStep(Math.max(1, currentStep - 1)); }}
                disabled={currentStep === 1}
                className="px-4 py-2 rounded-lg border border-gray-300 text-xs font-semibold text-gray-700 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-300 disabled:opacity-40 transition"
              >
                ← Previous Step
              </button>
              <button
                ...
                className="px-5 py-2 rounded-lg bg-brand-500 text-xs font-semibold text-white hover:bg-brand-600 disabled:opacity-40 transition shadow-sm"
              >
                Next Step →
              </button>
            </div>
